...
1. What kind of standard errors will you use?  Why are you using this kind of standard errors?^[For example, you could calculate standard errors and $p$-values using permutation-based [randomization inference](https://methods.egap.org/guides/analysis-procedures/randomization-inference_en.html).  Or you could closely approximate standard errors and $p$-values using analytic methods [@samii2012]]
