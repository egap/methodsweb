...
# ¿Qué es un Plan de Análisis Previo (PAP)?
...
En las siguientes seciones proporcionaremos información y ejemplos sobre los detalles que se deben incluir en los PAP. También recomendamos incluir la mayor cantidad posible de código y análisis de datos simulados.[^DD] Si bien muchos PAPs no podrán incluir todo lo que aparece en nuestra lista, todo PAP debería incluir, como mínimo, la lista completa de hipótesis que se pretenden evaluar, la forma en que se medirán las variables relevantes para operacionalizar dichas hipótesis y un sello de tiempo verificable.
...
# ¿Qué incluye un PAP? Resumen del diseño de investigación.
...
# ¿Qué incluye un PAP? Construcción de índices y mediciones.
...
# ¿Qué incluye un PAP? Procedimiento de estimación.
...
# ¿Qué incluye un PAP? Criterios de Inferencia{#infcrit}
...
# ¿Qué incluye un PAP? Procedimientos para Problemas de Datos
...
# ¿Qué incluye un PAP? Análisis de poder.
...
# ¿Cómo y dónde se registran los PAP?
