...
design](https://methods.egap.org/guides/data-strategies/cluster-randomization_en.html),
...
Huber-White standard errors correspond to the finite population framework, while the asymptotic theory justifying traditional cluster robust standard errors corresponds to the super population framework in regards the clusters. In a [cluster-randomized trial](https://methods.egap.org/guides/data-strategies/cluster-randomization_en.html), treatment is assigned to clusters, so there is also a finite-population-of-clusters perspective on cluster robust standard errors that is approximated in what are commonly known as CR2 standard errors (see @Pustejovsky2018).
