---
title: "10 cosas que debe saber sobre las pruebas de hipótesis"
author:
  - name: "Jake Bowers"
...
distinguir la señal del ruido. Como vimos en [10 cosas que debes saber sobre el  poder estadístico](/guides/assessing-designs/power_es.html), que un experimento pueda detectar un efecto de tratamiento no depende
...
pruebas:
 ...
 - Incluso si un procedimiento de prueba determinada controla la tasa de falsos positivos para una sola prueba, puede que no controle la tasa para un conjunto de   múltiples pruebas. Consulte [10 cosas que necesita saber sobre comparaciones múltiples](/guides/analysis-procedures/multiple-comparisons_en.html) para aprender más sobre los enfoques para controlar tales tasas de rechazo en  pruebas múltiples.
