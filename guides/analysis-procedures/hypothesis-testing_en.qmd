...
author: "Jake Bowers"
bibliography: hypothesis-testing.bib
image: hypothesis-testing.png
---
...
# 1. Hypothesis tests summarize information in research designs to help people reason about treatment effects
...
Statistical Power](https://methods.egap.org/guides/assessing-designs/power_en.html),
...
distinguish even faint signals from noise). See also [10 Things You Need to Know about Randomization Inference](https://methods.egap.org/guides/analysis-procedures/randomization-inference_en.html) for more discussion of these ideas.

# 2. In an experiment, a hypothesis is a claim about unobserved causal relationships
...
Recall from [10 Things to Know about Causal Inference](https://methods.egap.org/guides/causal-inference/causal-inference_en.html) that the counterfactual conceptualization of causality uses the idea of potential
...
The first approach changes the question from whether information causes a particular person to pay her taxes to whether information causes people to pay their taxes *on average*. [10 Types of Treatment Effect You Should Know About](https://methods.egap.org/guides/research-questions/effect-types_en.html) describes how a scientist can **estimate average causal effects** in a randomized experiment even though individual causal effects are unobservable. This insight is credited to Jerzy Neyman. Judea
...
# 3. The Null Hypothesis of No Effects is a precise statement about potential outcomes
...
# 4. The weak null hypothesis of no effects is a statement about aggregated potential outcomes
...
# 5. Randomization allows us to use what we observe to test hypotheses about what we do not observe.
...
This equation says that our observed outcome, $Y_i$ (here, amount of
...
# 6. Test statistics summarize the relationship between observed outcomes and treatment assignment.
...
statistic). To test the sharp null hypothesis of no effects, one may choose almost any test statistic such that the values of that function increase as the difference between treated and control outcomes increase (see @rosenbaum2002[Chapter 2], for a discussion of "effect increasing" test statistics).
...
# 7. $p$-values encode how much information a research design and test statistic tell us about the hypothesis. Hypothesis tests require distributions of the test statistic under the hypothesis.
...
test statistic given the research design entertaining the hypothesis (to get us back to the question of signal and noise).
...
of misleading ourselves. After all, recall from [10 Things You Need to Know About Multiple Comparisons](https://methods.egap.org/guides/analysis-procedures/multiple-comparisons_en.html) that even if there really is no effect, 100 independent and well operating
...
@rosenbaum2010design[Chapter 2] and @cox1977role for  more on the idea of
...
# 8. In simple hypothesis tests, we do not accept null hypotheses.
...
# 9. Once you are using $p$-values to reject a hypothesis, you will make errors
...
The [10 Things You Need to Know About Statistical Power](https://methods.egap.org/guides/assessing-designs/power_en.html)
...
# 10. What else to know about hypothesis tests.
...
testing:
 ...
 - Even if a given testing procedure controls the false positive rate for
   ...
   See [10 Things You Need to Know About Multiple Comparisons](https://methods.egap.org/guides/analysis-procedures/multiple-comparisons_en.html)
