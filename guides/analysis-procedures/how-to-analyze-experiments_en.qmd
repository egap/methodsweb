...
# Treatment variable: Confirm its randomization and values
==
...
For more information on blocking and how to implement it in R, see [10 Things You Need to Know About Randomization](https://methods.egap.org/guides/data-strategies/randomization_en.html). The precision gains from blocking (relative to covariate adjustment without blocking) tend to be greatest when sample sizes are small [@miratrix_et_al_2013].
...
If subjects receive different probabilities of assignment to treatment based on their covariates, then our estimation method needs to account for this (again, see [10 Things You Need to Know About Randomization](https://methods.egap.org/guides/data-strategies/randomization_en.html) for details).
