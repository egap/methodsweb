...
In practice, there may be differences between what you planned for your experiment, and what actually happened. These differences may have implications for how you should go about your estimation strategy.
...
List best practice -> point to the replication file
annotations , versions of packages, where to find which tables and figures etc etc 
...
##### all below needs to be revisited after Don Green response
