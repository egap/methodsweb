...
The next step is to write up the code to analyze your data. In general, the clearer, simpler, and more documented the code, the better. It's best practice to have written the code when filing the pre-analysis plan (in this case, it would be ready to go), but if this isn't the case, it's fine to write the code in its entirety now.

What are some best practices in writing up one's analysis code? An example of well-documented, simple and transparent experimental code can be found in the replication materials of @gaikwad_nellis_2021. 
