...
# it doesn't appear that there is a big threat of attrition being 
# related to treatment assignment

# run without interactions
t1attr1 <- lm_robust(i_attrition ~ i_t1, data = t1_experiment_df)

# run with treatment and covariates
t1attr2 <- lm_robust(i_attrition ~ i_t1 + , data = t1_experiment_df)

# run with treatment by covariate interactions (differential attrition by subgroups)


# then look w/in each block if blocked design

# note that an entire block could go missing
