...
## in R, an example of where we would locate the code to confirm
## the (complete) randomization is:

# set seed for reproducibility

set.seed(123) 

# the assignment to treatment using 'complete_ra'

experiment_data$treatment_complete <- complete_ra(N = nrow(experiment_data), 
                                                  prob = 0.5)
