...
What's important to note is that, in doing so, you _must indicate where you deviated from the PAP_. This will enhance the transparency and the reproducibility of your research. We touch more on this in a point below.
...
As mentioned earlier, it's normal to deviate from one's pre-analysis plan. We recommend _documenting_ and _reporting_ all such deviations. As you're conducting your analysis, we'd recommend keeping a list of where you deviate from your PAP. Each deviation should be highlighted and justified.

Moreover, a pre-registered report of your experiment, where you analyze the data as you'd pre-registered your analysis, should exist. It's best practice to cite this report in your study manuscript so readers can access it. Concretely, one path forward is to follow the guidance of @banerjeeetal2020, creating a short, publicly available report that they reference as a "populated PAP" that "populates the PAP to the extent possible and briefly discusses any barriers to doing so."
