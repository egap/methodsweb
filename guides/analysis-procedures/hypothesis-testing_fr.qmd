...
Comme nous l'avons vu dans [10 choses à savoir sur la puissance statistique](https://methods.egap.org/guides/assessing-designs/power_fr.html),
...
Voir également [10 choses à savoir sur l'inférence de randomisation](https://methods.egap.org/guides/analysis-procedures/randomization-inference_en.html) pour plus de détails sur ces idées.
...
[Dix types d'effet de traitement que vous devriez connaître](https://methods.egap.org/guides/research-questions/effect-types_fr.html) décrit une idée que nous créditons à Jerzy Neyman où un scientifique peut **estimer les effets causaux moyens** dans une expérience randomisée même si les effets causaux individuels ne sont pas observables.
...
Après tout, rappelons-nous des [10 choses sur les comparaisons multiples](https://methods.egap.org/guides/analysis-procedures/multiple-comparisons_en.html) :
...
Le guide [10 choses à savoir sur la puissance statistique](https://methods.egap.org/guides/assessing-designs/power_fr.html) explique comment nous voulons que l'hypothèse nulle soit rejetée lorsqu'elle est fausse (i.e. détecter le signal du bruit).
...
Nous énumérons ici quelques autres sujets importants mais avancés liés aux tests d'hypothèses :
  ...
  - Même si une procédure de test donnée contrôle le taux de faux positifs pour un seul test, elle peut ne pas contrôler le taux pour un groupe de tests multiples.
    Voir [10 choses à savoir sur les comparaisons multiples](https://methods.egap.org/guides/analysis-procedures/multiple-comparisons_en.html)
