...
* Optimal full- and pair-matching [@hansen_2004], and see the [optmatch package](https://github.com/markmfredrickson/optmatch)
* Optimal pair-matching with fine-balance via mixed integer programming [@zubizarreta_et_al_2014]. [See also the designmatch package](https://cran.rstudio.com/web/packages/designmatch) and the paper comparing approaches [@dla_resa_zubizarreta_2016]
* Optimal multi-level matching (for designs with schools and students) [@pimentel_et_al_2018]
* [Sparse optimal matching](https://www.stat.berkeley.edu/~spi/software.html)
* Generalized full matching [@savje_et_al_2017]
* [Coarsened exact matching](http://gking.harvard.edu/cem)
* Genetic matching [@diamond_sekhon_2013]
* Entropy balancing [@hainmueller_2012]
* Inverse propensity weighting [@glynn_quinn_2010]
