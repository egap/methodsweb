...
If we could provide one single piece of advice to make your code more reproducible for an experiment it would be: set a random seed before you sample units and randomly assign them to treatment. Random assignment is 

# You can make your treatment and data collection plans reproducible too

- Turn implementation decisions and activities into data [record when things happened and who did them, like enumerator names and treatment implementation schedules]
- record treatment materials 
