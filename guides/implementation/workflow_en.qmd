...
For each line of code, one or more tests can confirm that the result is as you expected. These tests can take many forms. One type is checking whether the data type is correct -- if you expected numbers, is the result numerical. Another is 
