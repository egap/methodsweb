...
author:
  ...
  - name: "Ashlea Rundlett"
  - name: "Jasper Cooper"
  - name: "Anna Wilke"
image: cluster-randomization.png
bibliography: cluster-randomization.bib
abstract: |
  Cluster randomized experiments allocate treatments to groups but measure outcomes at the level of individuals within those groups. This divergence between the level of assignment and the level of outcome measurement raises challenges for estimation and inference. This guide covers the key issues: information reduction from clustering, bias from unequal cluster sizes, within-cluster spillovers, design-based vs. model-based analysis, power analysis, and balance checking.
---
