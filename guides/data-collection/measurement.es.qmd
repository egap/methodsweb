...
# La validez de las conclusiones que sacamos de un experimento depende de la validez de las mediciones usadas. 
...
# Las mediciones son el enlace entre el argumento substantivo y/o teórico de un investigador y un diseño de investigación (experimental)
...
# Medir tratamientos incluye la operacionalización del tratamiento, además del cumplimiento de la asignación del tratamiento.
...
# La mayoría de variables de resultado de interés en las ciencias sociales son latentes.
...
# Hay dos tipos de error de medición que debemos considerar.
...
# Los errores de medición reducen el poder de su experimento. 
...
# El error de medición sistemático sesga las estimaciones de los efectos causales de los intereses. 
...
# Aproveche múltiples indicadores para evaluar la validez de una medida, pero tenga en cuenta las limitaciones de tales pruebas. 
...
# El uso de múltiples indicadores tiende a mejorar el poder de su experimento, pero puede introducir un reemplazo entre el sesgo y la eficiencia. 
...
# Mientras los conceptos pueden ser globales, muchos indicadores son específicos a los contextos.
