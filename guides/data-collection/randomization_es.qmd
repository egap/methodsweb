...
# Unas formas son mejores que otras
...
# Aleatorización en bloques: puede asegurarse de antemano que los grupos de tratamiento y control estén balanceados
...
# diseños factoriales: puede aleatorizar múltiples tratamientos al mismo tiempo sin perder poder
...
# Usted puede asignar  un conglomerado todo junto al tratamiento  (¡pero cuanto más grandes sean sus conglomerados, menos poder tendrá!)
...
# Puede aleatorizar de manera que sea fácil identificar si hay derrame de efectos
...
# Las probabilidades de asignación al tratamiento pueden variar de una unidad a otra
...
# Aleatorización restringida: si no le gusta lo que obtiene, puede empezar de nuevo
...
# Escriba un código para aleatorizar que le permita simular muchas aleatorizaciones posibles
...
# Puede aleatorizar conforme avanza
...
# A veces la aleatorización puede ser una forma ética de asignar un tratamiento, pero a veces no.
