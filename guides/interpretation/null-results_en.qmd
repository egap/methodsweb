...
***How can you tell if***...you have a mismatch between your intervention and randomization design? Consider whether treatment effects could vary, or service delivery might occur in a [cluster](https://methods.egap.org/guides/data-strategies/cluster-randomization_en.html), or intervention concepts could [spill over](https://methods.egap.org/guides/data-strategies/spillovers_en.html), and to what extent your randomization design accounted for that. 
