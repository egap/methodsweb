...
abstract: | 
  Voir ce guide^[Voir Holland (1986), Angrist et Pischke, Angrist, Joshua et Jörn-Steffen Pischke (2008). Mostly Harmless Econometrics: An Empiricist’s Companion. Princeton University Press.] pour une discussion plus formelle sur l'indépendance et les hypothèses nécessaires pour estimer les effets causaux.
...
# Effet moyen du traitement conditionnel
...
# Effet d'intention de traiter (intent to treat effect, ITT)
...
# Effet causal moyen pour ceux qui se conforment au traitement (complier average causal effect, CACE)
...
# Effet moyen du traitement d'une population ou d'un échantillon
...
# Effet moyen du traitement sur les traités et le contrôle
...
# Effet moyen du traitement par quantile
