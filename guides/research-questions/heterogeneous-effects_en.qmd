...
We can modify this model in order to estimate interaction effects. using the framework of @lin2013. 

We can add an additional term interacting $Z$ and $X$, which yields
$$
\begin{aligned}
Y_i &= \alpha + \beta Z_i + \gamma X_i + \delta Z_iX_i + \varupsilon_i \label{alt}
\end{aligned}
$$
