...
Some researchers may be interested in post-treatment effect modification, or the interaction between a treatment and a post-treatment covariate. For example, how do the effects of a job search assistance program vary with participants' levels of depression during the followup period? However, conditioning on a post-treatment covariate may lead to bias; estimation of both the main effect and the interaction effects may be biased when a post-treatment covariate is included as a regressor. See _cite angrist and pischke_ for more on bad controls.
