...
This guide discusses the theoretical and policy relevance of heterogeneous treatment effects. It also discusses and demonstrates methods for analyzing them: [TODO revamp] from testing for heterogeneity, to estimating subgroup treatment effects and their differences, to addressing the pitfalls of multiple comparisons and ad hoc specification search.[^1]
...
Studying treatment effect heterogeneity is important for theoretical and practical reasons. COME BACK TO THIS AFTER FINALIZING THE GUIDE AND MAKE IT AN OUTLINE FOR THE REST.

[this was originally under the second point] Research on such questions can inform theories about the conditions under which treatments are especially effective or ineffective. It can also help inform ways of designing and deploying policies so as to maximize their effectiveness. If resources will be utilized to deploy a large-scale policy intervention, there are good arguments to be made for deploying it where we have reasonable evidence that it will work. 


1. Are there differences? 
2. Do different subgroups react differently?
humble about extrapolation - perhaps it helps some, hurts others. sometimes specifically we care about sub-groups (tie to research question); targeting; theoretical expectations (previewed)

The second point should be written in a way that invites readers to the rest of the methods guide.
...
We can modify this model in order to estimate the CATE and interaction effects. 
